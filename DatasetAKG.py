...
class KnowledgeGraphAKG:
    def __init__(self, data_dir, gran=1,rev_set=0):
        ...
        #the earlist date in the dataset
        self.start_date = 2017
        self.n_time=5
    ...
    def load_triples(self):
        ...
        for triple in training_df:
            self.training_triples.append([self.entity_dict[triple[0]],self.entity_dict[triple[1]],self.relation_dict[triple[2]],triple[3]+1])
            self.training_facts.append([self.entity_dict[triple[0]],self.entity_dict[triple[1]],self.relation_dict[triple[2]],triple[3]+1,0])
        ...
        for triple in validation_df:
            self.validation_triples.append([self.entity_dict[triple[0]],self.entity_dict[triple[1]],self.relation_dict[triple[2]],triple[3]+1])
            self.validation_facts.append([self.entity_dict[triple[0]],self.entity_dict[triple[1]],self.relation_dict[triple[2]],triple[3]+1,0])
        ...
        for triple in test_df:
            self.test_triples.append([self.entity_dict[triple[0]], self.entity_dict[triple[1]], self.relation_dict[triple[2]],triple[3]+1])
            self.test_facts.append([self.entity_dict[triple[0]],self.entity_dict[triple[1]],self.relation_dict[triple[2]],triple[3]+1,0])
